...
(function ($) {
    ...
    POTENZA.searchbox = function () {
        if (jQuery('#search1').exists()) {
            jQuery('#search-btn1').on("click", function () {
                jQuery('#search1').toggleClass("search-open");
                return false;
            });
            jQuery("html, body").on('click', function (e) {
                if (!jQuery(e.target).hasClass("not-click")) {

                    jQuery('#search1').removeClass("search-open");
                }
            });
    ...
    POTENZA.searchbox2 = function () {
        if (jQuery('#search2').exists()) {
            jQuery('#search-btn2').on("click", function () {
                jQuery('#search2').toggleClass("search-open");
                return false;
            });
            jQuery("html, body").on('click', function (e) {
                if (!jQuery(e.target).hasClass("not-click")) {

                    jQuery('#search2').removeClass("search-open");
                }
            });
            jQuery("#search-btn1").on('click', function (e) {
                if (!jQuery(e.target).hasClass("not-click")) {
